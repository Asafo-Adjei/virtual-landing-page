  ...
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]' >
        <div className="text-center">
            <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2py- uppercase">
                feature
            </span>
                ...
                <div key={index} className="w-full sm:w-1/2 lg:w-1/3" >
                    <div className="flex">
                        ...
                        <div>
                            ...
                            <p className="p-2 mb-20 text-neutral-500"> {feature.description} </p>
                        </div>
